...
class RouteManager {
    ...
    private $routes = [
        ...
        'administrator.members_list' => '/administrator/liste-membres',
        ...
        'administrator.modifier_password' => '/administrator/modifier-password',
        ...
        'administrator.social' => '/administrator/social',
        'administrator.categories' => '/administrator/categories',
        'administrator.new_tontine' => '/administrator/nouvelle-tontine',
        'administrator.new_categorie' => '/administrator/nouvelle-categorie',
        'administrator.new_social' => '/administrator/nouveau-fond-social',
        ...
        'administrator.go_to_help_details' => '/administrator/passer-aux-renflouements',
        'administrator.go_to_borrowings' => '/administrator/passer-aux-emprunts',
        'administrator.go_to_tontines' => '/administrator/passer-aux-tontines',
        'administrator.go_to_savings' => '/administrator/passer-aux-epargnes',
        'administrator.go_to_exercise_debts' => '/administrator/passer-aux-fonds-sociaux',
        ...
        'administrator.back_to_social' => '/administrator/rentrer-au-fond-social',
        'administrator.back_to_borrowings' => '/administrator/rentrer-aux-emprunts',
        'administrator.back_to_exercise_debts' => '/administrator/rentrer-aux-fonds-sociaux',
        'administrator.back_to_help_details' => '/administrator/rentrer-aux-renflouements',
        'administrator.back_to_new_member' => '/administrator/rentrer-aux-inscriptions',
        ...
        'administrator.tontine_member' => '/administrator/tontine-membre',
        ...
        'administrator.delete_contribution' => '/administrator/supprimer-contribution',
        'administrator.delete_social' => '/administrator/supprimer-fond-social',
        'administrator.delete_categorie' => '/administrator/supprimer-categorie',
        ...
        'member.members_list' => '/member/liste-membres',
        'member.sessions' => '/member/sessions',
        'member.tontine_member' => '/member/tontine-membre',
        ...
        'member.modifier_password' => '/member/modifier-password',
